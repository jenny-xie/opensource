...
#+NAME: vars-other-tbl
 ...
 | env-var | execute | HOME       | $propositum.home                 | Set user home as required for winpython install            |
 | env-var | execute | SCOOP      | $propositum.root                 | Place scoop app/shim parent directories in the root folder |
