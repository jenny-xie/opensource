...
_*Installation & Usage:*_ /See the [[https://github.com/xeijin/propositum/releases][Releases]] for the latest binary distribution./
...
#+NAME: vars-other-tbl
 ...
 | path    | execute | propositum.root | $drv+"\"         | Propositum root folder                                         |
 | path    | execute | propositum.apps | $drv+"\apps"     | Propositum apps folder (scoop root)                            |
 | path    | execute | propositum.home | $drv+"\home"     | Propositum home folder (dotfiles & projects)                   |
 | path    | execute | propositum.font | $drv+"\fonts"    | Propositum fonts folder                                        |
...
:PROPERTIES:
:ID:       D2F4D214-0EE9-4A1B-8C25-C40BD4B06F78
:END:
...
*** COMMENT Vars  Test 
:PROPERTIES:
:ID:       AF0BBBC9-6359-4E38-9F82-12DE41B0334F
:END:
...
#+BEGIN_SRC powershell :tangle propositum-remove-propositum-drv-startup.ps1
