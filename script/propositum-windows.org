...
#+NAME: vars-other-tbl
 ...
 |---------+---------+-----------------+----------------------------+----------------------------------------------------------------|
 | hshtbl  | execute | propositum      | @{}                        | Initialises the hash table                                     |
 | hshitem | execute | propositum.root | $env:propositumDrv+"\"     | Propositum root folder                                         |
 | hshitem | execute | propositum.apps | $env:propositumDrv+"\apps" | Propositum apps folder (scoop root)                            |
 | hshitem | execute | propositum.home | $env:propositumDrv+"\home" | Propositum home folder (dotfiles & projects)                   |
 | hshitem | execute | propositum.font | $env:propositumDrv+"\font" | Propositum fonts folder                                        |
...
variable, therefore we need some additional logic to handle those.

*Note:* The ~type~ column here is important, 
