...
#+NAME: vars-other-tbl
 ...
 |---------+---------+------------------------+----------------------------+----------------------------------------------------------------|
 | hsh-tbl | execute | global:propositum      | @{}                        | Initialises the hash table                                     |
 | hsh-itm | execute | global:propositum.root | $env:propositumDrv+"\"     | Propositum root folder                                         |
 | hsh-itm | execute | global:propositum.apps | $env:propositumDrv+"\apps" | Propositum apps folder (scoop root)                            |
 | hsh-itm | execute | global:propositum.home | $env:propositumDrv+"\home" | Propositum home folder (dotfiles & projects)                   |
 | hsh-itm | execute | global:propositum.font | $env:propositumDrv+"\font" | Propositum fonts folder                                        |
